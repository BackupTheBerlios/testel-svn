...
/**Token zur Beschreibung von Punktuationszeichen.
 * @author mkalus
 *
 */
public class PunctuationToken extends Token {
	 ...
	 * @param className
	 */
	public PunctuationToken(String name, String className) {
	 ...
	 */
	public Token copy() {
		PunctuationToken newtok = new PunctuationToken(new String(getName()), new String(getClassName()));
